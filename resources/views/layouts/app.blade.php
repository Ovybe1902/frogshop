	...
	<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-link" href="/frogs">Shop</a></li>
						<li><a class="nav-link" href="/articles">Blog</a></li>
						<li><a class="nav-link" href="contact.html">Contact us</a></li>
					</ul>

					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><a class="nav-link" href="/client/login"><img src="{{asset('assets/images/user.svg')}}"></a></li>
					...
					<div class="row justify-content-between">
						...
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<img src="{{asset('assets/images/crapaud6-removebg-preview1.png')}}" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
		...
		<footer class="footer-section">
			<div class="container relative">
				...
				<div class="sofa-img">
					<img src="{{asset('assets/images/crapaud6-removebg-preview1.png')}}" alt="Image" class="img-fluid">
				</div>
